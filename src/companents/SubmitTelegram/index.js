...
const SubmitTelegtam = () => {
  const [userName, setUserName] = useState("");
  const [userAddress, setUserAddress] = useState("");
  const [userPhoneNum, setUserPhoneNum] = useState("");
  const [modal, setModal] = useState(false);

  let my_id = `-1002079325961`;
  let token = `6838992042:AAF_jS1O09oYUjo9WRlrsjegb3WElP-OWiE`;
      ...
      <div className="container">
        <div className=" w-full flex  items-center justify-center flex-col  gap-9">
          <input
            ...
            placeholder="Name"
            value={userName}
            className="py-2 px-0 38 text-[24px] w-[400px] bg-transparent border-b-2 outline-none text-white "
          />
          <input
